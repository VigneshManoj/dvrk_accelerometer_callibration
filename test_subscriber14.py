...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        mat_A = [[0, (c2 - c1) / tim_t, (b1 - b2) / tim_t],
                [(c2 - c1) / tim_t, 0, (a1 - a2) / tim_t],
                [(b2 - b1) / tim_t, (a1 - a2) / tim_t, 0]]
        mat_B = [twist_acc.x, twist_acc.y, twist_acc.x]

        x_val = np.dot((np.linalg.pinv(mat_A)), mat_B)
        print "Solved value of x is ", x_val
        ...
        var_temp2 = np.dot(omega_mat_end, r2)
